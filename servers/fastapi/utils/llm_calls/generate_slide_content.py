...
from utils.schema_utils import add_field_in_schema, remove_fields_from_schema, remove_length_constraints_from_schema
...
def get_system_prompt(
    ...
    return f"""
        ...
        - Keep the content concise, fit for a presentation slide, and write complete logical sentences.
        - Do not generate excessively long text that would overflow the slide layout visually.
        ...
        - For verbosity:
            - If verbosity is 'concise', then generate description focusing only on key points. Don't worry if you miss content or context.
            - If verbosity is 'standard', then generate a balanced description.
            - If verbosity is 'text-heavy', then generate a detailed and comprehensive description.

        User instructions, tone and verbosity should always be followed and should supercede any other instruction, except for slide schema and number of items.
...
async def get_slide_content_from_type_and_outline(
    ...
    response_schema = remove_length_constraints_from_schema(response_schema)
