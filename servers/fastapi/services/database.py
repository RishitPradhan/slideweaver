...
print("DEBUG: services.database: sql_engine created")
...
container_db_url = "sqlite+aiosqlite:///./app_data/container.db"
print(f"DEBUG: services.database: container_db_url={container_db_url}", flush=True)
