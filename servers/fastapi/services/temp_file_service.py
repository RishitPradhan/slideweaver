...
class TempFileService:
    ...
    def __init__(self):
        print("DEBUG: TempFileService: Initializing...")
        self.base_dir = get_temp_directory_env() or "./tmp/slideweaver"
        print(f"DEBUG: TempFileService: base_dir={self.base_dir}")
        try:
            self.cleanup_base_dir()
            print("DEBUG: TempFileService: cleanup_base_dir successful")
        except Exception as e:
            print(f"DEBUG: TempFileService: cleanup_base_dir failed: {e}")
        
        print(f"DEBUG: TempFileService: creating base_dir={self.base_dir}")
        os.makedirs(self.base_dir, exist_ok=True)
        print("DEBUG: TempFileService: Initialized successfully")
