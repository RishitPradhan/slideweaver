...
print("DEBUG: documents_loader: Importing constants...")
...
print("DEBUG: documents_loader: Importing DoclingService...")
from services.docling_service import DoclingService
print("DEBUG: documents_loader: Module loaded")
...
class DocumentsLoader:
    ...
    async def load_pdf(
        ...
        if load_text:
            document = await self.docling_service.parse_to_markdown(file_path)
    ...
    async def load_msword(self, file_path: str) -> str:
        return await self.docling_service.parse_to_markdown(file_path)
