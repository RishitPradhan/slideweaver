...
import SlideweaverMode from "./OnBoarding/SlideweaverMode";
...
export default function Home() {
  ...
  const [selectedMode, setSelectedMode] = useState<string>("slideweaver")
  ...
  return (
    ...
    //         <img src="/Logo.png" alt="Slideweaver Logo" className="h-12" />
    //       </div>
    ...
    <div className="flex h-screen">
      ...
      <main className="w-full pl-20 pr-8 max-w-[1440px] mx-auto relative z-10">
        ...
        {step === 2 && selectedMode === "slideweaver" && <SlideweaverMode currentStep={step} setStep={setStep} />}
