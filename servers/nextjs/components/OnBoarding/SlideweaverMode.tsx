...
const SlideweaverMode = ({ currentStep, setStep }: { currentStep: number, setStep: (step: number) => void }) => {
    ...
    return (
        <div className='w-full max-w-[640px] font-syne'>
            <p className='px-2.5 py-0.5 w-fit text-[#7A5AF8] rounded-[50px]  border border-[#EDEEEF] text-[10px] font-medium mb-5 font-syne'>SLIDEWEAVER</p>
...
export default SlideweaverMode
