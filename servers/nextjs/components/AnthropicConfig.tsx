          ...
          <div className="relative  w-[275px] ">
            ...
            {(!modelsChecked || (modelsChecked && availableModels.length === 0)) && (
              <button
                ...
                className={` mt-7 py-2.5 bg-[#F7F6F9] px-3.5 rounded-[48px] text-xs font-semibold text-[#ffffff] transition-all duration-200 border ${modelsLoading || !anthropicApiKey
