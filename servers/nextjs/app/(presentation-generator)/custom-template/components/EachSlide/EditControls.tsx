...
export const EditControls: React.FC<EditControlsProps> = ({
  ...
  return (
    <div className="border-2 max-w-[1280px] mx-auto border-red-900/50 rounded-lg p-4 bg-blue-50 space-y-4">
      {/* Drawing Tools */}
      ...
      <div className="space-y-2 mt-2">
        <label
          htmlFor="edit-prompt"
          className="text-sm font-medium font-inter text-neutral-300"
        >
        ...
        <div className="flex gap-2">
          <Textarea
            ...
            className="flex-1 font-inter duration-300 h-[70px] border-red-900/50 border-2 rounded-lg outline-none focus:border-red-600 focus:ring-0 max-h-[70px] resize-none"
            disabled={isUpdating}
          />
          <div>
            <Button
