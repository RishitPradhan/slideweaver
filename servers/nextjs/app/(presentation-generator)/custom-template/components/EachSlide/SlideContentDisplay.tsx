...
export const SlideContentDisplay: React.FC<SlideContentDisplayProps> = ({
  ...
  if (slide.error) {
    return (
      <div className="space-y-4">
        ...
        <div className="text-sm text-neutral-300 p-4 bg-red-50 rounded border border-red-200">
  ...
  return (
    <div className="space-y-4">
      <p className="text-base text-neutral-500">⏳ Waiting in queue to process...</p>
      <div className="animate-pulse space-y-3">
        <div className="h-6 bg-gray-200 rounded w-2/3"></div>
        <div className="h-6 bg-gray-200 rounded w-1/2"></div>
        <div className="h-64 bg-gray-200 rounded"></div>
