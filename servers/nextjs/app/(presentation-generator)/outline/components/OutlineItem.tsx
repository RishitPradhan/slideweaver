...
export function OutlineItem({
    ...
    return (
        <div
            ref={setNodeRef}
            style={style}
            className={`mb-4 bg-[#111111] rounded-[12px] group shadow-sm p-10 relative font-syne transition-all duration-500 hover:shadow-[0_6.6px_13.2px_0_rgba(220,38,38,0.15)] ${isDragging ? "opacity-50" : ""}`}
        >
            ...
            >
                ...
                <div id={`outline-item-${index}`} className="flex flex-col basis-full gap-2">
                    <p className="text-white w-fit text-[10px] font-medium  bg-[#111111] border border-neutral-800 rounded-[80px] px-2.5">slide {index}</p>
                ...
                <div className="hidden group-hover:flex absolute -top-3 -right-3 gap-1 sm:gap-2 items-center">
                    ...
                    <ToolTip content="Delete Slide">
                        <button
                            ...
                            className="p-1.5 sm:p-2 bg-[#111111] shadow-md  rounded-full transition-colors"
                        >
