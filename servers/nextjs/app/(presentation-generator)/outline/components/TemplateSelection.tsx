...
const BuiltInLayoutPreview = memo(({ layout, templateId, index }: {
  ...
  return (
    <div
      className="relative bg-[#222222] font-syne border border-neutral-800 overflow-hidden aspect-video rounded"
...
const BuiltInTemplateCard = memo(({ template, isSelected, onSelect }: {
  ...
  return (
    <Card
      className={`${isSelected ? 'border-2 border-red-600' : ''} cursor-pointer relative hover:shadow-lg transition-all duration-200 group overflow-hidden`}
      onClick={handleClick}
    >
      ...
      <div className="flex items-center justify-between p-5 bg-[#111111] border-t border-neutral-800 relative z-40">
        <div>
          <h3 className="text-sm font-bold text-white capitalize font-syne">
            {template.name}
          </h3>
          <p className="text-xs text-neutral-400  line-clamp-2 font-syne">
    ...
    <div className="space-y-[30px] mb-4">
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          <h3 className="text-base font-semibold text-white font-syne">Custom</h3>
        </div>
        {customTemplateCards}
      </div>
      {/* In Built Templates */}
      <div>
        <h3 className="text-base font-semibold text-white mb-3 font-syne">In Built</h3>
