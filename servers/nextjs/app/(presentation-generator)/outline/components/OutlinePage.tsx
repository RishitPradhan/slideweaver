      ...
      <Wrapper className="h-full  flex flex-col w-full relative px-5 sm:px-10 lg:px-20 ">
        <div className="flex-grow w-full hidden-scrollbar   mx-auto ">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="h-full flex flex-col">
            <TabsList className="my-4 h-auto w-fit  rounded-full border border-neutral-800 bg-[#111111] p-1.5">
              <TabsTrigger
                value={TABS.OUTLINE}
                className="rounded-full px-5 py-2  text-xs font-medium text-neutral-300 shadow-none data-[state=active]:bg-red-900/20 data-[state=active]:text-[#dc2626] data-[state=active]:shadow-none"
              >
                Outline & Content
              </TabsTrigger>
              ...
              <TabsTrigger
                value={TABS.LAYOUTS}
                className="relative rounded-full px-5  py-2 text-xs font-medium text-neutral-300 shadow-none  data-[state=active]:bg-red-900/20 data-[state=active]:text-[#dc2626] data-[state=active]:shadow-none"
              >
                Select Template
              </TabsTrigger>
            </TabsList>
            ...
            <div className="flex-grow w-full mx-auto">
              ...
              <TabsContent value={TABS.LAYOUTS} className="h-[calc(100vh-16rem)] bg-[#111111]  overflow-y-auto hide-scrollbar">
                <div>
                  <TemplateSelection
