          ...
          <div className="mt-6 space-y-4">
            ...
            <div className="max-h-[80vh] hide-scrollbar overflow-y-auto p-1">
              {loading ? (
                ...
                <div className="grid grid-cols-4 gap-4">
                  {icons.map((iconSrc, idx) => (
                    <div
                      ...
                      className="w-12 h-12 cursor-pointer group relative rounded-lg overflow-hidden hover:bg-[#222222] p-2 transition-colors"
                    >
                      <img
                        src={iconSrc}
                        alt={`Icon ${idx + 1}`}
                ...
                <div className="flex flex-col items-center justify-center w-full h-[60vh] text-center text-neutral-500 space-y-4">
