              ...
              <TabsContent value="generate" className="mt-4 space-y-4 overflow-y-auto hide-scrollbar h-[85vh]">
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-neutral-500">{promptContent}</p>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {isGenerating || !previewImages ? (
                      ...
                      <div
                        ...
                        className="aspect-[4/3] w-full overflow-hidden rounded-lg border cursor-pointer hover:border-red-600 transition-colors"
                      >
                        {previewImages && (
                          <img
                            src={previewImages}
                ...
                <div className="space-y-4">
                  ...
                  {(uploadedImageUrl || isUploading) && (
                    <div className="mt-4">
                      ...
                      <div className="aspect-[4/3] relative rounded-lg overflow-hidden border border-neutral-800">
                        {isUploading ? (
                          ...
                          uploadedImageUrl && (
                            ...
                            >
                              ...
                              <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                                <span className="bg-[#111111]/90 px-3 py-1 rounded-full text-sm font-medium">
                        ...
                        uploadedImages.map((image) => (
                          <div key={image.id}>
                            <div
                              ...
                              className="cursor-pointer group aspect-[4/3] rounded-lg overflow-hidden relative border border-neutral-800"
                            >
                              ...
                              <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-all duration-200" />
                              <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                                <span className="bg-[#111111]/90 px-3 py-1 rounded-full text-xs font-medium">
                                  Use
                                </span>
                              </div>
                            </div>
              ...
              <TabsContent value="edit" className="mt-4 space-y-4">
                <div className="space-y-4">
                  ...
                  <div
                    ...
                    className="aspect-[4/3] group  rounded-lg overflow-hidden relative border border-neutral-800"
                  >
                    ...
                    {isFocusPointMode && (
                      <div className="absolute inset-0 bg-black/20 flex items-center justify-center">
                        ...
                        >
                          ...
                          <div className="absolute w-16 h-0.5 bg-[#111111]/70 left-1/2 -translate-x-1/2"></div>
                          <div className="absolute w-0.5 h-16 bg-[#111111]/70 top-1/2 -translate-y-1/2"></div>
                        </div>
                      </div>
                    )}
                  </div>
                    ...
                    <div>
                      ...
                      <div className="flex gap-4">
                        ...
                        <Button
                          variant="outline"
                          className={cn(
                            objectFit === "fill" && "bg-blue-50 border-red-600"
                          )}
