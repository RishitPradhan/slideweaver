    ...
    >
        ...
        <>
          <div className="presentation-controls absolute top-4 right-4 flex items-center gap-2 z-50">
            <Button
              ...
              className="text-white hover:bg-[#111111]/20"
            >
              {isFullscreen ? (
      ...
      {currentSpeakerNote && (
        <div className="presentation-controls absolute bottom-4 right-4 z-50">
          {showSpeakerNotes ? (
            <div className="w-[360px] max-w-[50vw] rounded-xl border border-black/10 bg-[#111111]/95 shadow-xl backdrop-blur-sm">
              <div className="flex items-center justify-between border-b border-black/10 px-3 py-2">
                ...
                <Button
                  ...
                  className="h-8 px-2 text-neutral-400 hover:bg-black/5 hover:text-gray-800"
                >
                  <EyeOff className="mr-1 h-4 w-4" />
                  Hide
                </Button>
              </div>
              <div className="max-h-[28vh] overflow-auto whitespace-pre-wrap px-3 py-2 text-sm text-neutral-300">
                {currentSpeakerNote}
              </div>
            </div>
          ) : (
            <Button
              ...
              className="h-9 rounded-full border border-black/10 bg-[#111111]/95 px-3 text-gray-800 shadow-md hover:bg-[#111111]"
            >
