...
const SidePanel = ({
  ...
  return (
    <div className="bg-[#111111] border-r border-neutral-800 pt-8 px-4 w-[200px]">
      ...
      >
        ...
        >
          ...
          <p className="text-xl font-normal pb-3.5 text-white">Slides</p>
              ...
              {isStreaming ? (
                ...
                presentationData?.slides.map((slide: any, index: number) => (
                  <div
                    ...
                    className={` cursor-pointer ring-2   rounded-[12px] transition-all duration-200 ${selectedSlide === index ? ' ring-[#dc2626]' : 'ring-neutral-800'
                      }`}
                  >
                    <div className=" bg-[#111111] pointer-events-none  relative overflow-hidden aspect-video">
                      <div className="absolute bg-[#222222]/5 z-50  top-0 left-0 w-full h-full" />
          ...
          >
            ...
            <span className="text-[11px] font-normal text-white">Add Slide</span>
          </button>
        </div>
      </div>
