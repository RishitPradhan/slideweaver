  ...
  return (
    <>
      ...
      <div
        ...
        ref={modalRef}
      >
        <div className="bg-[#111111] rounded-lg shadow-2xl border border-neutral-800 overflow-hidden">
          {/* Header */}
            ...
            {categories.map((category) => (
              <button
                ...
                className={`px-3 py-1 rounded-full text-sm whitespace-nowrap ${selectedCategory === category
                    ...
                    : "bg-[#222222] text-neutral-300 hover:bg-gray-200"
                  }`}
              >
                {category}
              </button>
                ...
                {filteredQuestions.map((faq, index) => (
                  ...
                  >
                    ...
                    <AccordionContent className="px-1 pb-3">
                      <div className="text-sm text-neutral-400 leading-relaxed rounded bg-[#1a1a1a] p-3">
                        {faq.answer}
                      </div>
                    </AccordionContent>
                  </AccordionItem>
          ...
          {/* Footer */}
          <div className="bg-[#1a1a1a] px-6 py-3 border-t border-neutral-800 text-xs text-neutral-500 text-center">
            Still need help?{" "}
