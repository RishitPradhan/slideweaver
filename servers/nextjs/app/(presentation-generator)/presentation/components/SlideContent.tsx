    ...
    <>
      ...
      >
        ...
        >
              ...
              <ToolTip content="Add new slide below">
                {!isStreaming && (
                  <div
                    ...
                    className="  bg-[#111111] shadow-md w-[80px] py-2 border hover:border-[#5141e5] duration-300  flex items-center justify-center rounded-lg cursor-pointer mx-auto"
                  >
                    <PlusIcon className="text-neutral-500 text-base cursor-pointer" />
                  </div>
                )}
              </ToolTip>
            </div>
          ...
          {!isStreaming && (
            <div
              className={`absolute right-3 top-3 z-30 hidden md:flex flex-row items-center gap-2 rounded-[28px] border border-neutral-800/80 bg-[#111111]/95 px-2.5 py-2 ${isEditPopoverOpen || isSpeakerPopoverOpen
            ...
            >
              <Popover open={isEditPopoverOpen} onOpenChange={setIsEditPopoverOpen}>
                ...
                <PopoverContent
                  ...
                  align="center"
                  sideOffset={12}
                  className="z-30 w-[340px] rounded-2xl border border-neutral-800 bg-[#111111] p-0 shadow-2xl font-syne"
                >
                  <div className="border-b border-gray-100 px-4 py-3">
                    <p className="text-sm font-semibold text-white">Update slide</p>
                  ...
                  >
                    <Textarea
                      ...
                      className="min-h-[110px] max-h-[180px] w-full resize-none rounded-xl border border-neutral-800 p-3 text-sm focus-visible:ring-1 focus-visible:ring-[#5141e5]"
                      disabled={isUpdating}
                    ...
                    <button
                      disabled={isUpdating}
                      type="submit"
                      className={`ml-auto flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-[#9034EA] to-[#dc2626] px-4 py-2 text-sm font-medium text-white transition-opacity ${isUpdating ? "cursor-not-allowed opacity-70" : "hover:opacity-90"}`}
                    >
              ...
              <Popover open={isSpeakerPopoverOpen} onOpenChange={setIsSpeakerPopoverOpen}>
                <PopoverTrigger asChild>
                  <button
                    ...
                    className={`flex px-4 py-2.5 items-center justify-center rounded-full border font-syne ${slide?.speaker_note
                      ...
                      : "border-neutral-800 bg-[#111111] text-neutral-400"
                      }`}
                  >
                ...
                >
                  ...
                  <div className="space-y-3 p-4">
                    <div className="max-h-[220px] min-h-[100px] overflow-auto whitespace-pre-wrap rounded-xl border border-neutral-800 bg-[#1a1a1a] p-3 text-sm text-gray-800">
              ...
              <button
                ...
                className="flex px-4 py-2.5 items-center justify-center rounded-full border border-neutral-800 bg-[#111111] text-neutral-400 font-syne"
              >
