...
const PresentationPage: React.FC<PresentationPageProps> = ({
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-[#222222] font-syne">
        <div
          className="bg-[#111111] border border-red-300 text-red-700 px-6 py-8 rounded-lg shadow-lg flex flex-col items-center"
          role="alert"
        >
        ...
        <div className=" w-full h-[calc(100vh-20px)] hide-scrollbar pr-[25px] overflow-y-auto">
          ...
          <div
            ...
            style={{
              ...
              boxShadow: "0 0 20.01px 0 rgba(220, 38, 38, 0.16) inset",
            }}
            className="p-6 rounded-[20px] flex flex-col items-center overflow-hidden justify-center border border-neutral-800"
          >
