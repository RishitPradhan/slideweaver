...
const PresentationHeader = ({
  ...
  const ExportOptions = ({ mobile }: { mobile: boolean }) => (
    <div className={` rounded-[18px] max-md:mt-4 ${mobile ? "" : "bg-[#111111]"}  p-5`}>
      ...
      <div className="space-y-3">
        ...
        <Button
          ...
          variant="ghost"
          className={`  rounded-none px-0 w-full text-xs flex justify-start text-white hover:bg-transparent ${mobile ? "bg-[#111111] py-6 border-none rounded-lg" : ""}`} >
        ...
        <Button
          ...
          variant="ghost"
          className={`w-full flex px-0 justify-start text-xs text-white hover:bg-transparent  ${mobile ? "bg-[#111111] py-6" : ""}`}
        >
  ...
  return (
    <>
      <div className="py-7 sticky top-0 bg-[#111111] z-50 mb-[17px]  font-syne flex justify-between items-center">
        <h2 className="text-lg text-[#ffffff] font-unbounded "><MarkdownRenderer content={presentationData?.title || "Presentation"} className="mb-0  w-[600px] truncate text-sm text-[#ffffff] " /></h2>
        <div className="flex items-center gap-2.5">
          ...
          <div className="flex items-center gap-2 bg-[#F6F6F9] px-3.5 h-[38px] border border-[#EDECEC] rounded-[80px]">
            ...
            <ToolTip content="Regenerate Presentation">
              <button onClick={handleReGenerate} className="group">
                <RotateCcw className="w-3.5 h-3.5 text-[#ffffff] group-hover:text-[#5141e5] duration-300" />
              </button>
            </ToolTip>
            ...
            <ToolTip content="Undo">
              <button disabled={!canUndo} className=" disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer group" onClick={() => {
                ...
                <Undo2 className="w-3.5 h-3.5 text-[#ffffff] group-hover:text-[#5141e5] duration-300" />
            ...
            <ToolTip content="Redo">
              ...
              <button disabled={!canRedo} className=" disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer group" onClick={() => {
                ...
                <Redo2 className="w-3.5 h-3.5 text-[#ffffff] group-hover:text-[#5141e5] duration-300" />
            ...
            <ToolTip content="Present">
              <button
                ...
                <Play className="w-3.5 h-3.5 text-[#ffffff] group-hover:text-[#5141e5] duration-300" />
              </button>
            </ToolTip>
          </div>
          ...
          <Popover open={open} onOpenChange={setOpen} >
            <PopoverTrigger asChild>
              <button className="flex  items-center gap-[7px] px-[18px] py-[11px] rounded-[53px] text-sm font-semibold text-white bg-[#dc2626] hover:bg-red-700 transition-colors"
