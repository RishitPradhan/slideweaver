...
const UploadPage = () => {
  ...
  return (
    <Wrapper className="pb-10 lg:max-w-[70%] xl:max-w-[65%]">
      ...
      />
      <div className="rounded-2xl border border-red-900/30 bg-[#111111]/80 shadow-sm backdrop-blur supports-[backdrop-filter]:bg-[#111111]/60" >
        <div className="flex flex-col gap-4 md:items-center md:flex-row justify-between p-4">
          <div >
            <h2 className="text-lg font-unbounded tracking-tight text-white ">Configuration</h2>
            <p className="text-sm text-neutral-400 font-syne">Choose slides, tone, and language preferences.</p>
          </div>
        ...
        <div className="p-4 md:p-6">
          <h3 className="text-base font-normal font-unbounded  text-white mb-2">Content</h3>
        ...
        <div className="border-t border-red-900/30" />
        <div className="p-4 md:p-6">
          <h3 className="text-base font-normal font-unbounded text-white mb-2">Attachments (optional)</h3>
        ...
        <div className="p-4 md:p-6">
          <Button
            ...
            className="w-full rounded-[28px] flex items-center justify-center py-5 bg-[#dc2626] text-white font-syne font-semibold text-lg hover:bg-[#dc2626]/85 focus-visible:ring-2 focus-visible:ring-[#dc2626]/40"
