        ...
        <div className=''>
            <ToolTip content="Advanced settings" className='w-full h-full'>
                <button
                    ...
                    className=" w-full h-full flex items-center px-3 py-1 text-sm  bg-[#F7F6F9] hover:bg-[#F7F6F9] border-[#EDEEEF] focus-visible:ring-[#dc2626] border-none rounded-[48px] font-instrument_sans font-medium"
                >
                ...
                <DialogContent className="max-w-2xl font-instrument_sans">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div className="w-full flex flex-col gap-2">
                            ...
                            >
                                <SelectTrigger className="w-full font-instrument_sans capitalize font-medium bg-blue-100 border-red-900/50 focus-visible:ring-red-900/50">
                        ...
                        {/* Toggles */}
                        <div className="w-full flex flex-col gap-2 p-3 rounded-md bg-blue-100 border-red-900/50">
