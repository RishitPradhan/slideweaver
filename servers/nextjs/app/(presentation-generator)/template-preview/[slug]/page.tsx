...
const GroupLayoutPreview = () => {
    ...
    return (
      <div className="min-h-screen bg-[#1a1a1a]">
        ...
        <div className="flex items-center justify-center py-24">
          ...
          <span className="ml-3 text-neutral-400">Compiling templates...</span>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-[#1a1a1a]">
        ...
        <div className="flex flex-col items-center justify-center py-24">
          ...
          <p className="text-neutral-400 mb-4">{customError}</p>
  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a]">
      ...
      {/* Header */}
      <header className="bg-[#111111] shadow-sm border-b sticky top-0 z-30">
        <div className=" mx-auto px-6 py-6">
          ...
          <div className="text-center">
            <div className="flex items-center justify-center gap-2 mb-2">
              <h1 className="text-3xl font-bold text-white">{templateName}</h1>
              {isCustom && (
          ...
          <div className="space-y-12 w-[1440px] h-[720px] aspect-video mx-auto">
            {staticTemplates.map((template: any, index: number) => {
              ...
              return (
                ...
                >
                  <div className="bg-[#111111] px-6 py-4 border-b">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-3">
                        <span className="px-3 py-1 bg-[#222222] text-neutral-400 rounded text-sm font-mono">
                          {template.layoutId}
                        </span>
                  ...
                  <div className="bg-[#222222] p-6 flex justify-center overflow-x-auto">
                    <div
