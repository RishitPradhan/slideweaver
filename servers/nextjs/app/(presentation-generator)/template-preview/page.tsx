          ...
          {loading ? (
            ...
            [...Array(Math.min(4, template.layoutCount))].map((_, index) => (
              <div
                ...
                className="relative bg-gradient-to-br from-purple-50 to-blue-50 border border-neutral-800 overflow-hidden aspect-video rounded flex items-center justify-center"
              >
            ...
            previewLayouts.slice(0, 4).map((layout: CompiledLayout, index: number) => {
              ...
              return (
                <div
                  ...
                  className="relative bg-[#222222] border border-neutral-800 overflow-hidden aspect-video rounded"
                >
            ...
            [...Array(Math.min(4, template.layoutCount))].map((_, index) => (
              <div
                ...
                className="relative bg-[#222222] border border-neutral-800 overflow-hidden aspect-video rounded flex items-center justify-center"
              >
    ...
    <div className="min-h-screen bg-[#1a1a1a]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-white">All Templates</h1>
        ...
        <section>
          <div className="flex items-center justify-between mb-6">
            ...
            <a href="/custom-template" className="text-sm flex font-bold font-inter items-center justify-center gap-2  bg-[#dc2626] text-white px-4 py-2 rounded-md">
          ...
          {customLoading ? (
            <div className="flex items-center justify-center py-12">
              ...
              <span className="ml-3 text-neutral-400">Loading custom templates...</span>
            </div>
          ) : customTemplates.length === 0 ? (
            <Card className="p-8 text-center">
              <p className="text-neutral-500">No custom templates yet.</p>
