    ...
    <div className="space-y-6 px-6 font-syne">
      <div className='py-[28px] flex justify-between'>
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 rounded-xl px-4 py-2.5 text-white text-sm font-semibold font-syne shadow-sm hover:shadow-md"
                  ...
                  <div className='border-t border-[#EDEEEF] py-6 '>
                    <div className='flex justify-end px-5 gap-2'>
                      {currentStep > 1 && <button
                        ...
                        className='px-3.5 py-2.5 bg-[#F7F6F9] rounded-[48px] text-xs font-semibold text-[#ffffff]'
                        onClick={() => setCurrentStep(currentStep - 1)}
                      >Back</button>}

                      <button className='px-7 py-2.5 flex items-center gap-1 rounded-[48px] text-xs font-semibold text-[#ffffff] '
            ...
            <div
              ...
              <div className="space-y-4">
                <div
                  ...
                  className="overflow-y-auto overflow-x-hidden custom_scrollbar space-y-4 h-[90vh] rounded-lg shadow-lg border bg-[#111111]"
                >
