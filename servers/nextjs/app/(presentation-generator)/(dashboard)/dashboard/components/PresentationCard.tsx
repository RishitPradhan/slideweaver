  ...
  return (
    ...
    >
      <div suppressHydrationWarning={true} className="flex flex-col flex-1 relative z-40">
        ...
        <div className="w-full py-3 px-5 mt-auto z-40 relative bg-[#111111]  border-t border-[#EDEEEF]">
          <div className="flex items-center justify-between gap-7 w-full">
            ...
            <Popover>
              <PopoverTrigger className="w-6 h-6 hover:bg-[#222222] rounded-full flex items-center justify-center text-neutral-500 hover:text-neutral-300" onClick={(e) => e.stopPropagation()}>
                <EllipsisVertical className="w-6 h-6 text-neutral-500" />
              </PopoverTrigger>
              <PopoverContent align="end" className="bg-[#111111] w-[200px]">
                <button
                  className="flex items-center justify-between w-full px-2 py-1 hover:bg-[#222222]"
