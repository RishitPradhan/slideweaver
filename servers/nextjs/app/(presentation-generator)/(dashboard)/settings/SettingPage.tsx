...
const SettingsPage = () => {
  ...
  const [mode, setMode] = useState<'nanobanana' | 'slideweaver'>('slideweaver')
    ...
    <div className="h-screen font-syne flex flex-col overflow-hidden relative">
        ...
        <div className="w-full">
          <div className="sticky top-0 right-0 z-50 py-[28px]   backdrop-blur mb-4 ">
            <div className="flex  gap-3 items-center ">
              <h3 className=" text-[28px] tracking-[-0.84px] font-unbounded font-normal text-white flex items-center gap-2">
                Settings
              </h3>
          ...
          {mode === 'slideweaver' && selectedProvider === 'text-provider' && <TextProvider
            ...
            llmConfig={llmConfig}
          />}
          {mode === 'slideweaver' && selectedProvider === 'image-provider' && <ImageProvider llmConfig={llmConfig} setLlmConfig={setLlmConfig} />}
      ...
      {showDownloadModal && downloadingModel && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#111111]/95 backdrop-blur-md rounded-xl shadow-2xl max-w-md w-full p-6 relative">
            {/* Modal Content */}
