...
const ImageProvider = ({ llmConfig, setLlmConfig }: { llmConfig: LLMConfig, setLlmConfig: (config: any) => void }) => {
                ...
                <div className="w-[205px] mr-0 ml-auto">
                    ...
                    <div className="">
                        <Select value={llmConfig.DALL_E_3_QUALITY} onValueChange={(value) => input_field_changed(value, "DALL_E_3_QUALITY")}>
                            <SelectTrigger className="w-full h-12 px-4 py-4 outline-none border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-red-600 transition-colors hover:border-gray-400 justify-between">
    ...
    return (
        <div className="space-y-6 bg-[#F9F8F8] p-7 rounded-[12px] ">
            {/* API Key Input */}
            <div className="mb-4  bg-[#111111] p-10 pt-5 rounded-[12px]">
                                                        ...
                                                        <div className='w-[205px]'>
                                                            ...
                                                            <div className="relative">
                                                                <input
                                                                    ...
                                                                    className="w-full px-4 py-2.5 outline-none border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-red-600 transition-colors"
                                                ...
                                                <div className=" w-[205px]">
                                                    ...
                                                    <div className="relative">
                                                        <input
                                                            ...
                                                            className="w-full px-4 py-2.5 h-12 outline-none border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-red-600 transition-colors"
                            ...
                            {llmConfig.IMAGE_PROVIDER === "comfyui" && <div className='w-full'>
                                ...
                                <div className="relative">
                                    <textarea
                                        ...
                                        className="w-full px-4 py-2.5 outline-none border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-red-600 transition-colors font-mono text-xs"
                                        rows={3}
