...
const TextProvider = ({
    ...
    return (
        <div className="space-y-6 bg-[#F9F8F8] p-7 rounded-[12px] ">
            {/* API Key Input */}
            <div className="mb-4 flex items-center justify-between rounded-[12px] bg-[#111111] pt-5 pb-10 px-10">
                            ...
                            >
                                <PopoverTrigger asChild>
                                    <Button
                                        ...
                                        className="w-[205px] h-12 px-4 py-4 outline-none border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-red-600 transition-colors hover:border-gray-400 justify-between"
                                    >
                    ...
                    <div className="relative flex flex-col justify-end  items-end w-[205px] ">
                        <div className="flex flex-col justify-start ">
                                ...
                                <>
                                    {!useCustomOllamaUrl ? (
                                        <button
                                            ...
                                            className="mt-8 py-2.5 bg-[#EDEEEF] px-3.5 w-fit rounded-[48px] text-xs font-semibold text-[#ffffff] transition-all duration-200 border border-[#EDEEEF] hover:bg-[#E8F0FF]/90 focus:ring-2 focus:ring-blue-500/20"
                                        >
                                            Use Ollama URL
                                        </button>
                                    ) : (
                                        <>
                                            <label className="block text-sm font-medium capitalize text-neutral-300 mb-2">
                                                Ollama URL
                                            </label>
                                            <div className="relative">
                                                <input
                                                    ...
                                                    className="w-full px-2 py-3 outline-none border  border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-red-600 transition-colors"
                                ...
                                <>
                                    ...
                                    <div className="relative">
                                        ...
                                        <button
                                            ...
                                            className='absolute right-2 top-1/2 -translate-y-1/2 bg-[#111111] px-2 py-1 cursor-pointer'
                                        >
                                            {showApiKey ? <Eye className='w-4 h-4 text-neutral-500' /> : <EyeOff className='w-4 h-4 text-neutral-500' />}
                                        </button>
                                    </div>
                                </>
                            )}
                            {selectedProvider === 'custom' && (
                                <input
                                    ...
                                    className="w-full mt-2 px-2 py-3 outline-none border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-red-600 transition-colors"
                        ...
                        {selectedProvider !== 'ollama' && (!modelsChecked || (modelsChecked && availableModels.length === 0)) && (
                            ...
                            <button
                                ...
                                className={`mt-4 py-2.5 bg-[#EDEEEF] px-3.5 w-fit  rounded-[48px] text-xs font-semibold text-[#ffffff] transition-all duration-200 border ${modelsLoading
                                    ? " border-gray-300 cursor-not-allowed text-neutral-500"
                                    : " border-[#EDEEEF] text-[#ffffff] hover:bg-[#E8F0FF]/90 focus:ring-2 focus:ring-blue-500/20"
                                    }`}
                            >
                                {modelsLoading ? (
                                    ...
                                    >
                                        <PopoverTrigger asChild>
                                            <Button
                                                ...
                                                className="w-full h-12 px-4 py-4 outline-none border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-red-600 transition-colors hover:border-gray-400 justify-between"
                                            >
            ...
            <div className="bg-[#111111] flex justify-between items-center p-10 rounded-[12px]">
