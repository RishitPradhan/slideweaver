...
export const CustomTemplateCard = React.memo(function CustomTemplateCard({ template }: { template: CustomTemplates }) {
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-between p-5 bg-[#111111] border-t border-[#EDEEEF] relative z-40  ">
                <h3 className="text-sm font-bold w-[191px] text-white">
                    {template.name}
                </h3>
                ...
                <div className="flex xl:flex-row flex-col gap-6 xl:gap-0 items-center justify-between">
                    ...
                    <div className="flex  gap-2.5 max-sm:w-full max-md:justify-center max-sm:flex-wrap">
                        ...
                        <Link
                            ...
                            className="inline-flex items-center font-syne font-semibold gap-2 rounded-xl px-4 py-2.5 text-white text-sm  shadow-sm hover:shadow-md"
                ...
                <div className='p-1 rounded-[40px] bg-[#ffffff] w-fit border border-[#EDEEEF] flex items-center justify-center '>
                    <button className='px-5  py-2 text-xs font-medium text-[#3A3A3A] rounded-[70px]'
                        ...
                        style={{
                            ...
                            color: tab === 'custom' ? '#dc2626' : '#3A3A3A'
                        }}
                    >Custom</button>
                    ...
                    <button className='px-5  py-2 text-xs font-medium text-[#3A3A3A] rounded-[70px]'
                        ...
                        style={{
                            ...
                            color: tab === 'default' ? '#dc2626' : '#3A3A3A'
                        }}
                    >Built-in</button>
                </div>
