...
export const Schema = z.object({
    ...
    email: z.string().max(30).describe('Email address text').default('slideweaver@gmail.com'),
    website: z.string().max(30).describe('Website URL text').default('www.slideweaver.com'),
    footerImage: z.object({
        __image_url__: z.string(),
        __image_prompt__: z.string().max(100)
    }).default({
        __image_url__: "https://slideweaver-public-assets.s3.ap-southeast-1.amazonaws.com/replaceable_template_image.png",
